      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Este componente muestra mapas de Google Maps usando solo iframes gratuitos, 
            sin necesidad de API keys. Perfecto para sitios inmobiliarios.
          </p>
        </div>
        ...
        <div className="mt-12 bg-blue-50 rounded-xl p-6">
          ...
          <ul className="text-blue-800 space-y-2">
            <li>✅ <strong>Gratuito:</strong> No requiere API key de Google Maps</li>
            <li>✅ <strong>Fácil de usar:</strong> Solo pasa la dirección como prop</li>
            <li>✅ <strong>Personalizable:</strong> Ajusta zoom, tamaño y estilos</li>
            <li>✅ <strong>Responsive:</strong> Se adapta a diferentes tamaños de pantalla</li>
            <li>✅ <strong>Accesible:</strong> Incluye atributos de accesibilidad</li>
          </ul>
        </div>
      </div>
    </div>
